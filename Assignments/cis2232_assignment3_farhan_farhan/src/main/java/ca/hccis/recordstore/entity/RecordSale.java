...
public class RecordSale {
    ...
    // ===== Input Method currently modified to implement threads =====

    public void getInformationConsole() {
        // Same as before
    ...
    public void getInformationGui() {
        transactionDate = JOptionPane.showInputDialog("Enter transaction date (yyyy-MM-dd):");
        customerName = JOptionPane.showInputDialog("Enter customer name:");
        albumTitle = JOptionPane.showInputDialog("Enter album title:");
        artistName = JOptionPane.showInputDialog("Enter artist name:");

        String[] options = {"Vinyl", "CD", "Cassette"};
        formatType = (String) JOptionPane.showInputDialog(null, "Select format:", "Format",
                JOptionPane.QUESTION_MESSAGE, null, options, options[0]);

        String gift = JOptionPane.showInputDialog("Gift wrap? (Y/N):");
        giftWrapped = gift != null && gift.equalsIgnoreCase("Y");
